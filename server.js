            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                ...
                <td style="padding: 50px 40px;">
                  ...
                  <div style="background-color: #FFF8F0; border-radius: 6px; padding: 25px; margin: 30px 0;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding: 8px 0; color: #2C3E50; font-size: 15px;">
                          ✓ Wellness tracking device included
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 8px 0; color: #2C3E50; font-size: 15px;">
                  ...
                  <p style="margin: 30px 0 0 0; color: #2C3E50; font-size: 16px; line-height: 1.8;">
                    If you have any urgent questions in the meantime, feel free to reach out to us at <a href="tel:+919876543210" style="color: #217328; text-decoration: none; font-weight: 600;">+91 98765 43210</a> or reply to this email.
                  </p>
              ...
              <tr>
                <td style="background-color: #2C3E50; padding: 30px 40px; text-align: center;">
                  ...
                  <p style="margin: 0 0 8px 0; color: #E8F5E9; font-size: 14px;">
                    📞 <a href="tel:+919876543210" style="color: #E8F5E9; text-decoration: none;">+91 98765 43210</a>
                  </p>
