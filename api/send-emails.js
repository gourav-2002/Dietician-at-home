...
// Create transporter function (called at runtime to ensure env vars are loaded)
function createTransporter() {
  ...
  return nodemailer.createTransport({
    host: 'claret.herosite.pro',
    port: 465,
    secure: true,
    auth: {
      user: 'care@dieticianathome.com',
      pass: password
    }
  });
}

function getAdminEmailTemplate(name, email, phone, serviceType, preferredDateTime, message) {
  return `
    <!DOCTYPE html>
    <html>
    <head>
...
function getUserEmailTemplate(name) {
  return `
    <!DOCTYPE html>
    <html>
    <head>
                ...
                <td style="padding: 50px 40px;">
                  ...
                  <div style="background-color: #F1F8F4; border-left: 4px solid #217328; border-radius: 6px; padding: 25px; margin: 30px 0;">
                    ...
                    <ul style="margin: 0; padding: 0 0 0 20px; color: #2C3E50; font-size: 15px; line-height: 1.8;">
                      <li style="margin-bottom: 10px;">Our team will review your details and preferred consultation time</li>
                  ...
                  <div style="background-color: #FFF8F0; border-radius: 6px; padding: 25px; margin: 30px 0;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding: 8px 0; color: #2C3E50; font-size: 15px;">
                          - Weekly consultations with qualified Dieticians
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 8px 0; color: #2C3E50; font-size: 15px;">
                      ...
                      <tr>
                        <td style="padding: 8px 0; color: #2C3E50; font-size: 15px;">
                          - Professional monitoring device included
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 8px 0; color: #2C3E50; font-size: 15px;">
              ...
              <tr>
                <td style="background-color: #2C3E50; padding: 30px 40px; text-align: center;">
                  ...
                  <p style="margin: 0 0 8px 0; color: #E8F5E9; font-size: 14px;">
                    Email: <a href="mailto:care@dieticianathome.com" style="color: #E8F5E9; text-decoration: none;">care@dieticianathome.com</a>
                  </p>
                  <p style="margin: 0 0 8px 0; color: #E8F5E9; font-size: 14px;">
                    Phone: <a href="tel:+919899480775" style="color: #E8F5E9; text-decoration: none;">+91 98994 80775</a>
                  </p>
...
export default async function handler(req, res) {
  ...
  const { name, email, phone, serviceType, preferredDateTime, message } = req.body;
  ...
  try {
    ...
    await transporter.sendMail({
      from: '"Dietician at Home" <care@dieticianathome.com>',
      to: 'care@dieticianathome.com',
      subject: `New Query Received - ${name}`,
    ...
    await transporter.sendMail({
      from: '"Dietician at Home" <care@dieticianathome.com>',
      to: email,
      subject: 'Thank You for Reaching Out - Dietician at Home',
