...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Good Dietician in Gurgaon for Thyroid & Weight Loss',
        description: 'Find a good dietitian near me for weight loss & thyroid management in Gurgaon. Specialized plans for hypothyroid, hyperthyroid with weekly home consultations.',
        url: 'https://dieticianathome.com/programs/thyroid-management',
        siteName: 'Dietician at Home',
        images: [{
            url: 'https://dieticianathome.com/thyroid-management.jpg',
            width: 1200,
            height: 630,
    ...
    twitter: {
        ...
        title: 'Good Dietician in Gurgaon for Thyroid & Weight Loss',
        description: 'Find a good dietitian near me for weight loss & thyroid management in Gurgaon. Specialized plans for hypothyroid, hyperthyroid with weekly home consultations.',
        images: ['https://dieticianathome.com/thyroid-management.jpg'],
    },
    alternates: {
        canonical: 'https://dieticianathome.com/programs/thyroid-management',
    },
};
